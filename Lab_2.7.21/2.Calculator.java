          ...
          switch(act){
               case "+" -> {
                    try{
                         ...
                         if(!bool){
                              double sum = Double.parseDouble(txf1.getText()) + Double.parseDouble(txf2.getText());
                              txf3.setText(Double.toString(sum));
                         }else
               ...
               case "-" -> {
                    try{
                         ...
                         if(!bool){
                              double diff = Double.parseDouble(txf1.getText()) - Double.parseDouble(txf2.getText());
                              txf3.setText(Double.toString(diff));
                         }else
                              throw new Exception("Error");
               ...
               case "*" -> {
                    try{
                         ...
                         if(!bool){
                              double prod = Double.parseDouble(txf1.getText()) * Double.parseDouble(txf2.getText());
                              txf3.setText(Double.toString(prod));
                         }else
                              throw new Exception("Error");
               ...
               case "/" -> {
                    try{
                         ...
                         if(!bool){
                              double quo = Double.parseDouble(txf1.getText()) / Double.parseDouble(txf2.getText());
                              txf3.setText(Double.toString(quo));
                         }else
               ...
               case "%" -> {
                    try{
                         ...
                         if(bool){
                              ...
                              if(bool){
                                   int modu = Integer.parseInt(txf1.getText()) % Integer.parseInt(txf2.getText());
                                   txf3.setText(Integer.toString(modu));
                              }else
                                   throw new Exception("Error");
